...
class AlbumViewModel(application: Application, savedStateHandle: SavedStateHandle) :
    AndroidViewModel(application) {
    val app = application as JsonPlaceholderApp
    private val albumRepository = AlbumRepository(app.database, app.appExecutor)

    val albumList = albumRepository.readList()
}